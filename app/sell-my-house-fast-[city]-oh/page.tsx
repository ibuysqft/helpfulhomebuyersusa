...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!city) return {}
  return {
    title: `Sell My House Fast ${city.name} OH | Cash Offer in 24 Hours`,
    description: `We buy houses for cash in ${city.name}, ${city.county}, Ohio. No repairs, no fees, close in 7 days. Get your fair cash offer today.`,
    alternates: { canonical: `${siteConfig.url}/sell-my-house-fast-${citySlug}-oh` },
  }
}
